...
setx SPI_URI_SERVER_DEV "http://localhost.com.br/auth/realms/empresa-ad" /M
...
setx SPI_URI_SERVER_HML "http://localhost.com.br/auth/realms/empresa-ad" /M
...
setx SPI_URI_SERVER_PRD "http://localhost.com.br/auth/realms/empresa-ad" /M
